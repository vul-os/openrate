...
<p align="center">
  <sub>Current release: <a href="https://github.com/vul-os/openrate/releases/tag/v0.1.6">v0.1.6</a></sub>
</p>
...
```bash
curl -fsSLO https://raw.githubusercontent.com/vul-os/openrate/v0.1.6/scripts/verify.sh
bash verify.sh --tag v0.1.6 --attest openrate_0.1.6_source.zip
```
