...
<p align="center">
  <sub>Current release: <a href="https://github.com/vul-os/openrate/releases/tag/v0.1.4">v0.1.4</a></sub>
</p>
...
| *depends* | Ruby, where the answer turns on whether your server forks — [its README makes the call](https://github.com/vul-os/openrate/blob/main/sdks/ruby/README.md) | Ruby |
...
```bash
curl -fsSLO https://raw.githubusercontent.com/vul-os/openrate/v0.1.4/scripts/verify.sh
bash verify.sh --tag v0.1.4 --attest openrate_0.1.4_source.zip
```
