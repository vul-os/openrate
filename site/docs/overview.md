...
<p align="center">
  <img src="https://raw.githubusercontent.com/vul-os/openrate/main/brand/logo.svg" width="84" alt="openrate" />
</p>
...
[ACCURACY.md](#accuracy). The web UI shows the grade in the converter and a
...
React UI (including the **Geist Sans** and **Geist Mono** webfonts, whose
OFL-1.1 licence must travel with the shipped `.woff2` files —
