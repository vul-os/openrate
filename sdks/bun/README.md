...
```
bun        1.3.14 on darwin/arm64
sidecar    http://127.0.0.1:65242
api        http://127.0.0.1:65242/api/v1
...
meta        default base ZAR, sources [{"name":"ecb","edges":29,"last_ok":"2026-08-09T14:37:55.261596Z"}]
...
1. **The Go runtime lives in your process** — its GC, its scheduler, and its
   ...
   JavaScriptCore installs its own signal handling.
