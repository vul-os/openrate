<!-- Generated from SOURCES.md by `go run ./site/gen`. Do not edit this file — edit the source and regenerate. -->
...
sources. See [`.env.example`](https://github.com/vul-os/openrate/blob/main/.env.example).
...
and `tradermade` as *exchange* — see [ACCURACY.md](#accuracy).
