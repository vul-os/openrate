...
and provenance: [Sources](#sources).
...
the US FRED benchmark series. Full detail: [Interest rates](#interest-rates).
...
- [API reference](#api)
- [Embed as a Go library](#library) — the same options, programmatically
