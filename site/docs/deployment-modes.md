...
Bindings for both of those live in [`sdks/`](https://github.com/vul-os/openrate/blob/main/sdks) — C, C++, Go, Python,
...
Use the [C ABI](#c-abi). In-process conversion measured **3.7 µs mean**
