...
<p align="center">
  <img src="assets/app/board-dark.webp" alt="The openrate rates board against a ZAR base, showing a grade, hop count and age per currency, with the EUR row expanded to reveal its graph path and the two sources quoting it, 16.7 basis points apart." width="900">
</p>
