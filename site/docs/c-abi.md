<!-- Generated from docs/c-abi.md by `go run ./site/gen`. Do not edit this file — edit the source and regenerate. -->
...
**The full ABI reference lives in [`ffi/README.md`](https://github.com/vul-os/openrate/blob/main/ffi/README.md)** — every
...
there instead.** [`sdks/README.md`](https://github.com/vul-os/openrate/blob/main/sdks/README.md) is the index — it names
...
functions. (No `.dll` is built — see what is built
...
seeing them. Each is expanded in [`ffi/README.md`](https://github.com/vul-os/openrate/blob/main/ffi/README.md).
...
Rust package's [`tests/handles.rs`](https://github.com/vul-os/openrate/blob/main/sdks/rust/tests/handles.rs) is what that
...
|---|---|
| Go — [`ffi/abi/abi_test.go`](https://github.com/vul-os/openrate/blob/main/ffi/abi/abi_test.go) | `Call(engineHandle, "refresh", …)` must return an error, or "the split is not enforced at the ABI, so a host could make openrate fetch without ever constructing a refresher" |
| C — [`ffi/test/smoke.c`](https://github.com/vul-os/openrate/blob/main/ffi/test/smoke.c) | the same call through a really-`dlopen`'d library: *an engine handle refuses `"refresh"` — fetching needs a refresher, always* |
...
control). See [Proving it sends nothing](#zero-network).
...
one of the thirteen non-Go [language packages](https://github.com/vul-os/openrate/blob/main/sdks/README.md) with a direct
...
held down by [`ffi/abi/lifecycle_test.go`](https://github.com/vul-os/openrate/blob/main/ffi/abi/lifecycle_test.go), which
...
equal by value. So the [API reference](#api) is also the ABI's response
reference.
...
response shapes are tabulated in [`ffi/README.md`](https://github.com/vul-os/openrate/blob/main/ffi/README.md).
...
[`ffi/test/smoke.c`](https://github.com/vul-os/openrate/blob/main/ffi/test/smoke.c).
...
waiting to use. Full shape: [the API reference](#api).
...
[`sdks/`](https://github.com/vul-os/openrate/blob/main/sdks/README.md), outside `ffi/`, and each one binds against
...
**[`sdks/README.md`](https://github.com/vul-os/openrate/blob/main/sdks/README.md) is the index**: the fifteen languages,
...
|---|---|
| Links or `dlopen`s the library directly | [C](https://github.com/vul-os/openrate/blob/main/sdks/c/README.md) · [C++](https://github.com/vul-os/openrate/blob/main/sdks/cpp/README.md) · [Rust](https://github.com/vul-os/openrate/blob/main/sdks/rust/README.md) · [Swift](https://github.com/vul-os/openrate/blob/main/sdks/swift/README.md) |
| Through the runtime's own FFI | [Python](https://github.com/vul-os/openrate/blob/main/sdks/python/README.md) (`ctypes`) · [Ruby](https://github.com/vul-os/openrate/blob/main/sdks/ruby/README.md) (`fiddle`) · [PHP](https://github.com/vul-os/openrate/blob/main/sdks/php/README.md) (`FFI`) · [Java](https://github.com/vul-os/openrate/blob/main/sdks/java/README.md) (FFM, JDK 22+) · [Kotlin](https://github.com/vul-os/openrate/blob/main/sdks/kotlin/README.md) (over the Java binding) · [.NET](https://github.com/vul-os/openrate/blob/main/sdks/dotnet/README.md) (`LibraryImport`) · [Node](https://github.com/vul-os/openrate/blob/main/sdks/node/README.md) (koffi) · [Bun](https://github.com/vul-os/openrate/blob/main/sdks/bun/README.md) (`bun:ffi`) · [Deno](https://github.com/vul-os/openrate/blob/main/sdks/deno/README.md) (`Deno.dlopen`) |
| **Never touches the ABI** | [Go](https://github.com/vul-os/openrate/blob/main/sdks/go/README.md) — imports the package · [Elixir](https://github.com/vul-os/openrate/blob/main/sdks/elixir/README.md) — sidecar only, deliberately |

Three of those deserve a pointer of their own:

- **C is the ground truth.** Every other package is doing what
  [`sdks/c/direct_convert.c`](https://github.com/vul-os/openrate/blob/main/sdks/c/direct_convert.c) does, in its own
...
- **Go is not an FFI binding at all.** Go programs import the library, so no
  ...
  platform matrix. See [Embed as a Go library](#library).
...
- [`sdks/README.md`](https://github.com/vul-os/openrate/blob/main/sdks/README.md) — the index for all fifteen languages
- [`ffi/README.md`](https://github.com/vul-os/openrate/blob/main/ffi/README.md) — the reference this page points at
- [Which mode should I choose](#deployment-modes)
- [API reference](#api) — the same JSON, over HTTP
