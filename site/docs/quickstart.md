...
distinction has its own section in the [API reference](#api), and it is the
...
[`sdks/README.md`](https://github.com/vul-os/openrate/blob/main/sdks/README.md) is the index: which of the two each
...
|---|---|---|
| [bun](https://github.com/vul-os/openrate/blob/main/sdks/bun/README.md) | `cd sdks/bun && bun run examples/direct.ts` | `cd sdks/bun && bun run examples/sidecar.ts` |
| [C](https://github.com/vul-os/openrate/blob/main/sdks/c/README.md) | `cd sdks/c && make && ./direct_convert` | `cd sdks/c && make && ./sidecar_convert` |
| [C++](https://github.com/vul-os/openrate/blob/main/sdks/cpp/README.md) | `cd sdks/cpp && make && ./direct_convert` | `cd sdks/cpp && make && ./sidecar_convert` |
| [Deno](https://github.com/vul-os/openrate/blob/main/sdks/deno/README.md) | `cd sdks/deno && deno task example:direct` | `cd sdks/deno && deno task example:sidecar` |
| [.NET](https://github.com/vul-os/openrate/blob/main/sdks/dotnet/README.md) | `sdks/dotnet/run-examples.sh direct` | `sdks/dotnet/run-examples.sh sidecar` |
| [Elixir](https://github.com/vul-os/openrate/blob/main/sdks/elixir/README.md) | — **no direct mode, deliberately** | `cd sdks/elixir && mix run examples/sidecar_convert.exs` |
| [Go](https://github.com/vul-os/openrate/blob/main/sdks/go/README.md) | `sdks/go/examples/run.sh direct` | `sdks/go/examples/run.sh sidecar` |
| [Java](https://github.com/vul-os/openrate/blob/main/sdks/java/README.md) | `sdks/java/run-examples.sh direct` | `sdks/java/run-examples.sh sidecar` |
| [Kotlin](https://github.com/vul-os/openrate/blob/main/sdks/kotlin/README.md) | `sdks/kotlin/run-examples.sh direct` | `sdks/kotlin/run-examples.sh sidecar` |
| [Node](https://github.com/vul-os/openrate/blob/main/sdks/node/README.md) | `cd sdks/node && npm install && npm run example:direct` | `cd sdks/node && npm install && npm run example:sidecar` |
| [PHP](https://github.com/vul-os/openrate/blob/main/sdks/php/README.md) | `php sdks/php/examples/direct_convert.php` | `php sdks/php/examples/sidecar_convert.php` |
| [Python](https://github.com/vul-os/openrate/blob/main/sdks/python/README.md) | `python3 sdks/python/examples/direct_convert.py` | `python3 sdks/python/examples/sidecar_convert.py` |
| [Ruby](https://github.com/vul-os/openrate/blob/main/sdks/ruby/README.md) | `ruby sdks/ruby/examples/direct_convert.rb` | `ruby sdks/ruby/examples/sidecar_convert.rb` |
| [Rust](https://github.com/vul-os/openrate/blob/main/sdks/rust/README.md) | `sdks/rust/examples/run.sh direct` | `sdks/rust/examples/run.sh sidecar` |
| [Swift](https://github.com/vul-os/openrate/blob/main/sdks/swift/README.md) | `sdks/swift/run.sh direct` | `sdks/swift/run.sh sidecar` |
...
[API reference](#api) is the response reference for direct mode too.
...
Both traps are covered in [Troubleshooting](#troubleshooting).
...
[Use it from another language](#c-abi): it is not fork-safe, no Windows DLL
...
| If you want… | Read |
|---|---|
| your language's package in detail | [`sdks/README.md`](https://github.com/vul-os/openrate/blob/main/sdks/README.md) — the index for all fifteen |
| the C ABI those packages are built on | [Use it from another language](#c-abi) |
