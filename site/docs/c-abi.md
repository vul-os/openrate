...
Bindings live in [`sdks/`](https://github.com/vul-os/openrate/blob/main/sdks), outside `ffi/`, and each binds against
...
| Language | README |
|---|---|
| C | [`sdks/c`](https://github.com/vul-os/openrate/blob/main/sdks/c/README.md) — the ground truth; every other binding is doing what `direct_convert.c` does |
| C++ | [`sdks/cpp`](https://github.com/vul-os/openrate/blob/main/sdks/cpp/README.md) — header-only C++17 RAII wrapper |
| Go | [`sdks/go`](https://github.com/vul-os/openrate/blob/main/sdks/go/README.md) — no FFI, no shared library, no platform matrix: you import a package |
| Python | [`sdks/python`](https://github.com/vul-os/openrate/blob/main/sdks/python/README.md) |
| Ruby | [`sdks/ruby`](https://github.com/vul-os/openrate/blob/main/sdks/ruby/README.md) |
| PHP | [`sdks/php`](https://github.com/vul-os/openrate/blob/main/sdks/php/README.md) |
| Rust | [`sdks/rust`](https://github.com/vul-os/openrate/blob/main/sdks/rust/README.md) |
| Java | [`sdks/java`](https://github.com/vul-os/openrate/blob/main/sdks/java/README.md) |
| Elixir | [`sdks/elixir`](https://github.com/vul-os/openrate/blob/main/sdks/elixir/README.md) |
...
to them; see [Embed as a Go library](#library). And **Elixir declines to
