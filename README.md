...
<p align="center">
  <sub><a href="LICENSE-MIT">MIT</a> OR <a href="LICENSE-APACHE">Apache-2.0</a> · Go 1.25+ · no API key · self-hostable</sub>
</p>
...
<p align="center">
  <img src="site/assets/app/converter-dark.webp" alt="The openrate converter: 100 USD converted to ZAR, with a B grade seal and the six quality facets — confidence, freshness, directness, source class and corroboration — read out beneath the number." width="900">
</p>
...
[ACCURACY.md](ACCURACY.md). The web UI shows the grade badge in the converter
...
`fxsource/registry.go`. Full catalog + freshness notes: [SOURCES.md](SOURCES.md).
...
[docs/library.md](docs/library.md#the-noui-build-tag) for the measured size
...
regenerate. See [docs/web-ui.md](docs/web-ui.md).
