...
[configuration](configuration.md#the-bucket-map-is-capped).
...
Symptoms specific to the fifteen packages in [`sdks/`](../sdks/README.md). The
...
[Use it from another language](c-abi.md) and
...
measurement is in [`sdks/java/README.md`](../sdks/java/README.md).)
